...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| protocol | string | No | The protocol to send. USDT have `ERC20`, `OMNI` and `TRX` to choose. <br> Each currency has its protocol. You can get protocol information from [The limitations-and-fees](../open/lims-fees.md) API.   | `MAIN` | `MAIN`, `ERC20`, `OMNI`, `TRX` | `ERC20` |
