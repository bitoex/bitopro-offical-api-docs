...
| :--- | :--- | :--- |
| 2021/03/17 | v3.5.3 | In [Get Withdraw](auth/get-withdraw.md), add `timestamp` field and deprecate `datetime` field. Support [Get Withdraw History](auth/get-withdraw-history.md) and [Get Deposit History](auth/get-deposit-history.md).
